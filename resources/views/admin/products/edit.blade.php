...
@push('scripts')
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            myDropzone.on("sending", function(file,percentage,bytes) {
                console.log("sending");
                console.log(file,percentage)
            });
            myDropzone.on("sucess", function(file,percentage,bytes) {
                console.log("Sucesso")
            });
            ...
            myDropzone.on("queuecomplete", function (file) {
                ...
                console.log('Completed', 'All product images uploaded', 'success', 'fa-check');
            });
